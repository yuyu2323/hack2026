...
def test_cli_database_alias_rejects_external_or_wrong_database(monkeypatch):
    ...
    values = {'DATABASE_URL':'postgresql+psycopg://storeloop@127.0.0.1:55442/storeloop',
              'STORELOOP_TEST_DATABASE_URL':'postgresql+psycopg://storeloop@127.0.0.1:55442/storeloop_test'}
    ...
    for value in ['postgresql+psycopg://storeloop@example.invalid:55442/storeloop',
                  'postgresql+psycopg://storeloop@127.0.0.1:5432/storeloop',
                  'postgresql+psycopg://storeloop@127.0.0.1:55442/other',
                  'postgresql+psycopg://storeloop@127.0.0.1:55442/storeloop?options=x',
