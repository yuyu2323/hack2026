...
- backend(PostgreSQL 포함)/AI/runtime/security/client/frontend/UI/build: 모두 exit 0. `validation-04.json` 참조.
- `./start.sh` 기본 실행: API·AI health, 실제 DB의 세 역할 로그인과 Vite 프록시 인증 응답, HTML 역할 경로 200 및 관리 프로세스 4개 확인. `runtime-04.json` 참조.
